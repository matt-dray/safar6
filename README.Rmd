...
The game is text-based and takes place entirely in the console. Start a game like `x <- safar6::SafariZone$new()`. Be warned: it's tricky. But then so was the original.
